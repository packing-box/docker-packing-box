...
def add_argument(parser, *names, **kwargs):
    ...
    for name in names:
        if name == "aggregate":
            ...
            parser.add_argument("-mik", "--mi-kbest", type=float, default=0.7, help="threshold for mutual information feature selection",
                                note="If mi_kbest >= 1, the mi_kbest best features will be kept. If within (0.0, 1.0), the mi_kbest percent of features will be kept.")
