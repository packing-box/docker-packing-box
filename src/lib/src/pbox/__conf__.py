...
bi.config = Config("packing-box",
    # defaults
    {
        ...
        'cfg': {
            ...
            'include_cut_edges':      ("false", "BOOL", "include the stored information about edges that got cut", _bl),
            'only_opcodes':           ("false", "BOOL", "store only the opcodes of each instruction in the node", _bl),
