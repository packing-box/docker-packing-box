...
EXTRACTORS = {
    'All': {
        ...
        'entrypoint':                     lambda exe: exe.abstract.entrypoint,
        'exported_functions':             lambda exe: exe.abstract.exported_functions,
        'imported_functions':             lambda exe: exe.abstract.imported_functions,
        'relocations':                    lambda exe: exe.abstract.relocations,
        'section_characteristics':        section_characteristics,
        'standard_sections':              standard_sections,
        'symbols':                        lambda exe: exe.abstract.symbols,
    },
    'ELF': {
        'elfeats': elfeats,
    },
